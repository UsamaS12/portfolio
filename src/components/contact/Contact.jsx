  ...
  return (
    <section className="contact section" id="contact">
        ...
        <div className="contact_container container grid">
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <a href="mailto:uxamashahid364@gmail.com.com" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">0316-6513628</span>
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">usama.b90</span>
            ...
            <div className="contact_content">
                <h3 className="contact_title">Write about info about your Project</h3>
